    ...
    <div className=''>
      <div className='border border-[black] z-5 h-[600px] mb-0 relative overflow-hidden group transition'>
        <div className='w-full h-full flex justify-center'>
         ...
         <BsCircleFill className='absolute items-center top-[520px] right-60 opacity-0 group-hover:opacity-100 transition duration-300' size={14}/>
         <BsCircle className='absolute top-[520px] right-56 opacity-0 group-hover:opacity-100 transition duration-300' size={14}/>
         <BsCircle className='absolute top-[520px] right-52 opacity-0 group-hover:opacity-100 transition duration-300' size={14}/>
         </div>
        </div>
